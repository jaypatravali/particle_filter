...
def img_resize(list1, list2):
	dir1 = '/export/patraval/robo_car_new_loop_all/zed_front/network/net_output_upsample/'
	dir2= '/export/patraval/robo_car_new_loop_all/zed_front/network/network_blend_upsample/'
